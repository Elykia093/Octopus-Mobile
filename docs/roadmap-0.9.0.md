# Octopus-Mobile 0.9.0 Roadmap

## Focus

- Polish cross-module loading, success, failure, empty, and stale states.
- Reduce hardcoded operation copy so UI text follows shared resources and language settings.
- Improve destructive-action clarity and dense-list ergonomics before the 1.0 audit.
